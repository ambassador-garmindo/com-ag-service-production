...
namespace Manufactures.Tests.Queries.GarmentCuttingOuts
{
	public class MonitoringCuttingCommandHandlerTest : BaseCommandUnitTest
	{
		...
		public MonitoringCuttingCommandHandlerTest()
		{
            ...
            SalesDataSettings.Endpoint = "https://com-ag-service-sales.azurewebsites.net/v1/";
        ...
        public async Task Handle_StateUnderTest_ExpectedBehavior()
        {
            ...
            _mockGarmentCuttingOutItemRepository
                ...
                {
                    new GarmentCuttingOutItem(guidCuttingOutItem,guidCuttingIn,guidCuttingInDetail,guidCuttingOut,new ProductId(1),"productCode","productName","customsCategory","designColor",100).GetReadModel()
                }.AsQueryable());
            ...
            _mockGarmentPreparingItemRepository
                ...
                {
                     new GarmentPreparingItem(garmentPreparingItem,1,new Domain.GarmentPreparings.ValueObjects.ProductId(1),"productCode","productName","designColor",1,new Domain.GarmentPreparings.ValueObjects.UomId(1),"uomUnit","fabricType",1,1,guidGarmentPreparing,null,"customsCategory").GetReadModel()
                }.AsQueryable());
