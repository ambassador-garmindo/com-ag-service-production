...
namespace Manufactures.Tests.Queries.GarmentPreparings.WIP
{
    public class XlsWIPCommandHandlerTest : BaseCommandUnitTest
    {
        ...
        //        {
        //            new GarmentFinishingOutItem(guidFinishingOutItem,guidFinishingOut,new Guid(),new Guid(),new Domain.Shared.ValueObjects.ProductId(1),"","","customsCategory","",new SizeId(1),"",10, new Domain.Shared.ValueObjects.UomId(1),"","",10,10,10).GetReadModel()
        //        }.AsQueryable());
