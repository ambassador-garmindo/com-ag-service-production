...
namespace Manufactures.Domain.GarmentFinishingOuts
{
    public class GarmentFinishingOutItem : AggregateRoot<GarmentFinishingOutItem, GarmentFinishingOutItemReadModel>
    {
        ...
        public GarmentFinishingOutItem(Guid identity, Guid finishingOutId, Guid finishingInId, Guid finishingInItemId, ProductId productId, string productCode, string productName, string customsCategory, string designColor, SizeId sizeId, string sizeName, double quantity, UomId uomId, string uomUnit, string color, double remainingQuantity, double basicPrice, double price) : base(identity)
        {
            //MarkTransient();
